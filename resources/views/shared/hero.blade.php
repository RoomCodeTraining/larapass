<section class="w-full relative bg-white">
    ...
    <div class="flex max-w-7xl lg:flex-row flex-col px-10 relative mx-auto py-12 lg:py-32">
        <div class="lg:w-1/2 w-full lg:max-w-none max-w-2xl mx-auto relative flex items-start justify-center flex-col">
            <div class="relative">
                <div class="relative flex -rotate-2 text-black px-3 mb-10 md:mb-4 py-1.5 uppercase font-bold text-xs">
                    <span class="absolute inset-0 rounded bg-gray-300 z-20"></span>
                    <span class="w-full h-full absolute rounded right-0 -mr-0.5 top-0 mt-0.5 bg-gray-400"></span>
                    <span class="relative z-20">{{ __('Les meilleurs evenements du moment') }}</span>
                </div>
            </div>
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-6 relative">
                Expolorer
                <span class="relative inline-block">
                    <span class="relative z-10 p-6">les</span>
                    <svg class="w-full fill-current rotate-12 -mt-4 text-yellow-300 absolute right-0 top-0"
            ...
            <p class="text-gray-500 text-xl lg:max-w-md">Larapass : Votre portail vers une multitude d'expériences inédites, à portée de main. Découvrez, réservez et partagez des moments mémorables, le tout depuis une seule plateforme.</p>
            <div class="flex md:flex-row flex-col mt-7 md:w-auto w-full md:space-y-0 space-y-5 md:space-x-2">
                <a href="#_"
                    class="px-6 py-3 md:w-auto w-full text-center text-lg bg-blue-600 text-white rounded font-bold">Decouvrir maintenant</a>
                <a href="#_" class="px-6 py-3 text-lg bg-gray-200 text-center text-gray-700 rounded font-bold">Publier un evenement</a>
            </div>
        </div>
        <div class="lg:w-1/2 w-full lg:max-w-none max-w-2xl mx-auto lg:pt-0 pt-16 lg:pl-10 xl:pl-0">
            <img src="https://cdn.devdojo.com/images/march2022/hero-01.png">
        </div>
    </div>
</section>
